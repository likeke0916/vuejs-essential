          ...
          <ul class="list list-group">
            <li v-for="(item, index) in resources" class="list-group-item">
              <a :href="item.link" target="_blank">
                <img class="media-object inline-block " src="http://ask.qcloudimg.com/http-save/yehe-1148782/5o8gp7zatp.png">
                {{ item.title }}
              </a>
            </li>
          </ul>
...
export default {
      ...
      slides: [
        {
          ...
          img: 'http://cdn.duitang.com/uploads/item/201502/27/20150227205904_cuQ3a.thumb.700_0.jpeg',
          link: 'https://learnku.com/laravel/t/3383/laravel-the-first-chinese-new-book-laravel-tutorial'
        },
        {
          title: '《Laravel 进阶课程 - 从零构建论坛系统》',
          img: 'http://cdn.duitang.com/uploads/item/201206/09/20120609134848_YX5iw.thumb.700_0.jpeg',
          link: 'https://learnku.com/laravel/t/6592'
        },
        {
          title: '《Laravel 教程实战高级 - 构架 API 服务器》',
          img: 'http://img4.imgtn.bdimg.com/it/u=3136075639,3338708347&fm=26&gp=0.jpg',
  ...
  //在实例创建后完成
  created(){
    //通过axios执行get请求来返回活跃用户
    this.$axios.get('/users/active').then( (response)=> {
      //在成功的回调里,从response.data获取返回数据
